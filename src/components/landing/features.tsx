...
const features = [
  {
    ...
    description:
      "Centralized approval, ministry-independent, or self-service signups. Every church works differently.",
    icon: (
  ...
  },
  {
    ...
    description:
      "See and prevent conflicts across worship, kids, tech, and greeters — all in one view.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Never schedule a parent and child at the same time in different ministries. Families stay in sync.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="mx-auto max-w-5xl">
        <AnimateIn>
          ...
          <p className="mx-auto mt-4 max-w-xl text-center text-lg text-vc-text-secondary">
            Built specifically for churches with multiple volunteer teams who need flexible, cross-ministry scheduling.
          </p>
        </AnimateIn>
