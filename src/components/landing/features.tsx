...
const features = [
  ...
  },
  {
    ...
    description:
      "One view covers every team: worship, events, outreach, operations. Conflicts surface before they become a problem.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Link household members so they're never double-booked across teams. Families, couples, and roommates stay coordinated. Scheduling respects real-life connections.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Scan a QR code, get prompted at service time, or check in by proximity. Attendance logs itself. No clipboard, no paper sign-in.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Track engagement, spot burnout early, and care for the people who serve. Health classifications surface who needs attention. Archive or remove inactive volunteers when needed.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Build your order of service with a full song library, accurate CCLI metadata, and drag-and-drop planning. Publish plans, track song usage, and export CSV reports for CCLI compliance.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Before generating a schedule, broadcast availability requests to your team. Track responses and build smarter schedules with real data.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Each team lead reviews and approves their section before the schedule goes live. Full visibility into who has signed off and who hasn't.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    title: "Stage Sync",
    description:
      "Broadcast your order of service in real time. The conductor advances items while the team follows along on any device: phone, tablet, or laptop.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Define prerequisites, track completion, and gate scheduling eligibility. Background checks, training classes, and orientation sessions tracked in one place.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    title: "Children's Check-In & Labels",
    description:
      "Secure child check-in with name tag and guardian receipt label printing. Grade-based room assignment, capacity tracking, and overflow routing built in.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Book rooms with a visual calendar, manage equipment, handle approval workflows, and share facility availability across organizations that cohabitate the same building.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
