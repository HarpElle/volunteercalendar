...
const features = [
  ...
  },
  {
    ...
    description:
      "Track engagement, spot burnout early, and care for the people who serve. Archive inactive volunteers or remove them entirely — health classifications surface who needs attention.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    title: "Stage Sync",
    description:
      "Broadcast your order of service in real time. The conductor advances items while the team follows along on any device — phones, tablets, or laptops.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Define prerequisites, track completion, and gate scheduling eligibility. Background checks, training classes, and orientation sessions — all managed in one pipeline.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
