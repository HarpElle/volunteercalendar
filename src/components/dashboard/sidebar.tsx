...
export function Sidebar({
  ...
  return (
    <aside className="hidden lg:sticky lg:top-0 lg:flex lg:h-screen lg:w-64 lg:flex-col lg:border-r lg:border-vc-border-light lg:bg-vc-bg-warm">
      {/* Sidebar header — org card at top */}
      <div className="px-4 pt-5 pb-2">
        <div className="flex items-center gap-3 rounded-xl bg-vc-sand/15 px-3 py-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-vc-coral/12 text-sm font-bold text-vc-coral">
            {orgInitial}
          </div>
          <div className="min-w-0 flex-1">
            <p className="truncate text-sm font-semibold text-vc-indigo">
