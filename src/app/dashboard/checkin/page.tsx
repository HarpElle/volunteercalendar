  ...
  return (
    <div>
                ...
                {activationCode ? (
                  <>
                    ...
                    <p className="text-[11px] text-vc-text-muted mt-1.5">
                      ...
                      <Link href="/dashboard/checkin/settings?tab=stations" className="underline">
                        Settings → Stations
                      </Link>
                      .
                    </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        />
        <QuickAction
          href="/dashboard/checkin/settings?tab=children"
          label="Settings"
          description="Check-in windows and thresholds"
