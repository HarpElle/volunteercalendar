...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://volunteercal.com/opengraph-image.png",
        width: 1200,
        height: 630,
        alt: "VolunteerCal — Flexible Volunteer Scheduling",
      },
    ],
  },
  twitter: {
    ...
    title: "VolunteerCal — Flexible Volunteer Scheduling",
    description:
      "Auto-generate fair, conflict-free volunteer schedules. Leaders review. Volunteers confirm.",
    images: ["https://volunteercal.com/opengraph-image.png"],
  },
};
