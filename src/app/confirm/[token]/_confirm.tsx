      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="font-display text-xl font-bold text-vc-indigo">VolunteerCal</span>
          </Link>
        </div>
            ...
            <div className="px-6 py-6">
              ...
              <div className="mb-6 space-y-3 rounded-xl bg-vc-bg-warm p-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium uppercase tracking-wide text-vc-text-muted">Team</p>
        ...
        <p className="mt-6 text-center text-xs text-vc-text-muted">
          Powered by <Link href="/" className="text-vc-coral hover:underline">VolunteerCal</Link>
        </p>
      </div>
    </div>
  );
